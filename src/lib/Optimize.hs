...
data UTLS n = UTLS
type UTLM = GenericTraverserM TopEmissionsForbidden UTLS
...
instance GenericTraverser TopEmissionsForbidden UTLS where
...
type ULM = GenericTraverserM TopEmissionsForbidden ULS
...
instance GenericTraverser TopEmissionsForbidden ULS where
...
instance GenericTraverser TopEmissionsForbidden LICMS where
  traverseExpr = \case
    ...
    where
      rebuildBody :: LamBinder i i' -> Block i'
                  ...
                  -> GenericTraverserM TopEmissionsForbidden LICMS i n (Atom n)
