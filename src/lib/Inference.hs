...
type DictSynthTraverserM = GenericTraverserM TopEmissionsForbidden DictSynthTraverserS
...
instance GenericTraverser TopEmissionsForbidden DictSynthTraverserS where
