...
-- === visitor defaults based on substitution ===0
...
-- XXX: This doesn't handle the `Var` and `SimpInCore` cases. These should be
...
instance SubstE AtomSubstVal (WithDecls r e) where
  substE = undefined
