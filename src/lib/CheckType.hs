...
instance (IRRep r) => CheckableE r (LamExpr r) where
  checkE (LamExpr bs body) = undefined
...
typeCheckExpr effs expr = undefined
...
instance IRRep r => HasType r (TabPiType r) where
  getTypeE (TabPiType b resultTy) = undefined
...
typeCheckPrimHof effs hof = undefined
...
typeCheckDAMOp effs op = undefined
