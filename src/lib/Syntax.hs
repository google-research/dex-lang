...
module Syntax (
    ...
    IRVariant (..), SubstVal (..), AtomName,
    ImpName, ImpNameBinder, DataDefName, ClassName, AtomSubstVal,
...
data ImpAtom n =
 ...
 -- differently. ImpAtomTabVal implicitly dereferences buffer, which is assumed
 -- to be immutable.
 | ImpAtomTabRef [IExpr n] (FlatTabTy n) (ImpAtomType n)
 | ImpAtomTabVal [IExpr n] (FlatTabTy n) (ImpAtomType n)
...
data ImpAtomType n =
 ...
 -- differently. ImpAtomTabVal implicitly dereferences buffer, which is assumed
 -- to be immutable.
 | ImpAtomTabRefTy (FlatTabTy n) (ImpAtomType n)
 | ImpAtomTabValTy (FlatTabTy n) (ImpAtomType n)
 -- To load from the box we dereference each of the pointers in the `[IExpr n]`
 -- list and interpret them as an `ImpAtom n` of the given type
 ...
 | ImpAtomProductTy [ImpAtomType n] (ImpAtomType n)
 | ImpAtomSumTy (ImpAtomType n) [[ImpAtomType n]] -- tag, payloads
   deriving (Show, Generic)

data FlatTabTy n = FlatTabTy
  { flatTabSize   :: IExpr n
  , flatTabOffset :: Abs (Nest IBinder) IExpr n }
  deriving (Show, Generic)
...
instance Store (FlatTabTy n)
instance Store (ImpAtom n)
instance Store (ImpAtomType n)
