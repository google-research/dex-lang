...
type OperandEnv n = Env Operand n
type OperandEnvFrag n l = EnvFrag Operand n l
...
compileInstr instr = case instr of
  ...
  ICall f@(AnnVar fname (LiftH (IFunType cc argTys resultTys))) args -> do
