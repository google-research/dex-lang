...
generalizeIxDict :: EnvReader m => CExpr n -> m n (Generalized CoreIR CExpr n)
generalizeIxDict dict = undefined
...
generalizeArgs ::EnvReader m => CorePiType n -> [CExpr n] -> m n (Generalized CoreIR (ListE CExpr) n)
