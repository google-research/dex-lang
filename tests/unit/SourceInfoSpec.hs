...
posTree :: SpanTree
posTree = Span (0, 10, 0) [Span (0, 5, 1) [LeafSpan (0, 2, 2), LeafSpan (4, 5, 3)], LeafSpan (7, 9, 4)]
...
spec = do
  ...
  describe "SpanTreeTest" do
    ...
    it "overlapping spans" do
      traceM ("overlapping spans\n" ++ show (fmap drawTree (makeSpanTree overlappingSpansCode overlappingSpans)))
    ...
    it "works 4" do
      let htmlText = treeToHtml' (T.pack xs) positionFilledSpanTree in
        trace ("htmlText: " ++ renderHtml htmlText)
        renderHtml htmlText `shouldBe` "<span id=\"0\" class=\"code-span\"><span>0</span><span id=\"1\" class=\"code-span\"><span id=\"2\" class=\"code-span-leaf\">1</span><span>23</span><span id=\"3\" class=\"code-span-leaf\">4</span></span><span>56</span><span id=\"4\" class=\"code-span-leaf\">78</span><span>9</span></span>"
